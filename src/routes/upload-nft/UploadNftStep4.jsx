...
export default function UploadNftStep4() {
    return (
        <MainLayout>
            <HeroContainer>
                            ...
                            <div className="border border-color__light5 text-center bg__light4 bw__3 border-radius__30 p-5 h-100">
                                <div class="steps">
                                    <ul class="steps-list">
                                        ...
                                        <li class="steps-list-item completed"><span></span>Step 4</li>
                                ...
                                <h2 className="font-poppins-semibold text-center mb-5 mt-4">Where would you like to place your NFT?</h2>
                                <div className="w-100 text-center pt-4">
                                    <Link to="/upload-nft/step5" className="btn bg-transparent border-radius__24 bw__2 border mx-3 text-white px-5">Yes</Link>
                                    <Link to="/upload-nft/step3" className="btn bg-transparent border-radius__24 bw__2 border mx-3 text-white px-5">No</Link>
                                </div>
                            </div>
                        </div>
                    </div>
